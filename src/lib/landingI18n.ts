...
export const landingStrings = {
  mn: {
    ...
    mascot: {
      ...
      bubble: 'Сайн уу! Би Моко. Чиний санхүүгийн зөвлөх, найз чинь. Цуглуулсан жижиг царцсан мод болгон чамайг том зорилгод хүргэнэ.',
      name: 'Моко',
    ...
    how: {
      ...
      steps: [
        ...
        { title: 'Ургуулах', desc: 'Хуримтлалаа царцсан мод шиг өсгө.' },
      ],
    },
    stats: {
      items: [
    ...
    cta: {
      heading: 'Өнөөдрөөс эхэлье. Анхны царцсан модоо хуримтлуулъя.',
